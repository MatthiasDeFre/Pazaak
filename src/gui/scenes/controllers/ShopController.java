...
public class ShopController implements Initializable, _Scene
{
    ...
    @FXML
    private ImageView imgSelectedCard; //@matthias, wnr je over een kaart hovert word(t) die hier in het groot getoont
    @FXML
                    ...
                    if (cardGUI.isInteractable())
                    {
                        ...
                        switch (card[0])
                        {
                            case "+":
                                ...
                                lblExplanation.setText(rs.getString("descAdd"));
                                break;
                            case "-":

                                lblExplanation.setText(rs.getString("descMin"));
                                break;
                            case "+/-":

                                lblExplanation.setText(rs.getString("descPM"));
                                break;
                            case "D":

                                lblExplanation.setText(rs.getString("descD"));
                                break;
                            case "1+/-2":

                                lblExplanation.setText(rs.getString("desc1PM2"));
                                break;
                            case "xT":

                                lblExplanation.setText(rs.getString("descT"));
                                break;
                            case "2&4":

                                lblExplanation.setText(rs.getString("desc2And4"));
                                break;
                            case "3&6":

                                lblExplanation.setText(rs.getString("desc3And6"));
                                break;
                        }
